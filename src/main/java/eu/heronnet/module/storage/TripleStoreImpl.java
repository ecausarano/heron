...
//import eu.heronnet.core.model.RawBundle.BundleBuilder;
//import eu.heronnet.core.model.RawStatement;
...
//
//            RawStatement statement = triple.getStatement();
...
//
//    @Override
//    public List<RawBundle> findByPredicate(List<Triple> triples) {
//        ArrayList<RawBundle> bundles = new ArrayList<>();
...
//
//    @Override
//    public List<RawBundle> findByHash(List<byte[]> searchKeys) {
//        Transaction txn = environment.beginTransaction(null, null);
//        ArrayList<RawBundle> bundles = new ArrayList<>();
...
//                        RawBundle bundleForSubjectId = getBundleForSubjectId(txn, foundTriple.getSubject());
...
//    }
//
//    private RawBundle getBundleForSubjectId(Transaction txn, final byte[] subjectId) {
...
//            }
//            RawBundle bundle = bundleBuilder.build();
...
//        RawStatement<String> statement = triple.getStatement();
